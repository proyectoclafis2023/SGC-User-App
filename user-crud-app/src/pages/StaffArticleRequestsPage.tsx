...
import { Package, Search, ShoppingCart, CheckCircle2 } from 'lucide-react';
...
export const StaffArticleRequestsPage: React.FC = () => {
    ...
    const requestableArticles = articles.filter((a: any) => 
        (a.canRequestByStaff === 1 || a.canRequestByStaff === true || a.category === 'Insumos') && 
        !a.isArchived && a.isActive
    );
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
            ...
            {successMessage && (
                <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 p-6 rounded-[2.5rem] flex items-center gap-4 animate-in zoom-in duration-300 shadow-sm">
