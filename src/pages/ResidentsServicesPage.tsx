...
import { 
    HardHat, Phone, Mail, Clock, Search, ExternalLink, 
...
export const ResidentsServicesPage: React.FC = () => {
    ...
    const publicContractors = contractors.filter((c: any) => c.isActive && c.showToResidents);

    const filtered = publicContractors.filter((c: any) =>
